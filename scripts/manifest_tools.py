...
def append_usage_sections(lines: list[str]) -> None:
    ...
    lines.append("```")
    lines.append("https://github.com/bdousa/PythonFeed-Update/releases/download/requests-v2.34.2/requests-2.34.2-py3-none-any.whl")
    lines.append("https://github.com/bdousa/PythonFeed-Update/releases/download/numpy-v2.4.6/numpy-2.4.6-cp313-cp313-win_amd64.whl")
    lines.append("```")
    lines.append("")
