...
def find_request_items(
    ...
    fields = "sys_id,number,short_description,request,cat_item,state,stage,opened_at,opened_by,requested_for,requested_for.email,opened_by.email,comments"
    ...
    if args.ticket:
        ...
        request_items = service_now_get(
            ...
            "sc_req_item",
            {
                ...
                "sysparm_fields": "sys_id,number,short_description,request,cat_item,state,stage,opened_at,opened_by,requested_for,requested_for.email,opened_by.email,comments",
                "sysparm_limit": "1",
                "sysparm_display_value": "true",
            },
        )
